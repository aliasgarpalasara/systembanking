...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  ?>
      ...
      <!-- Introduction section -->
            ...
            <div>
                <div class="heading text-center my-4">
                  <h3 style="color:white; padding-top:10px;">WELCOME TO</h3>
                  <h1 style=" color:white;">SPARKS FOUNDATION BANK</h1>
                </div>
              </div>
            </div>
			<div class="container-fluid" >
			<div class="container-fluid-sm" >
               <img src="image/BankofRhodes.jpg" style=" width:100%;height:10%; ">
      </div>
      </div>
      ...
      <div class="footer">
        <p> Made by <b>ALI PALASARA</b> <br> The Sparks Foundation</p>
		<p><a href="https://github.com/aliasgarpalasara"><i class="fa fa-github" style="font-size:36px;color:blue;"></i></a>
		<a href="https://www.linkedin.com/in/aliasgar-palasara-6500bb216/"><i class="fa fa-linkedin-square" style="font-size:36px;color:blue"></i></a>
		</p>
      </footer>
